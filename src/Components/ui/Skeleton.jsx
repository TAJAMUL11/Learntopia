...
export const Skeleton = ({ className = "" }) => (
  <div className={`skeleton bg-surface-2 ${className}`} aria-hidden="true" />
);

// A card-shaped placeholder that mirrors the course card footprint.
export const CardSkeleton = ({ className = "" }) => (
  <div className={`rounded-2xl border border-white/10 bg-surface p-5 shadow-clay ${className}`} aria-hidden="true">

...
export const contentTranslations = {
  ...
  en: {
    ...
    toasts: {
      ...
      btnRetry: "Try again",
      // Messages
      loginSuccess: "You're signed in. Let's keep that streak going!",
      loginGoogleSuccess: "You're signed in with Google. Let's keep it going!",
      signupSuccess: "Your account is ready — time to explore courses and earn XP!",
      signupGoogleSuccess: "Your account is ready — time to explore courses and earn XP!",
      quizScoreSaved: "Your score is saved to the leaderboard. Nice work!",
      ...
      logoutSafe: "You're signed out safely. Come back tomorrow to keep your streak alive!",
      logoutFailed: "Failed to log out.",
      loggedOut: "You're signed out safely. Come back tomorrow to keep your streak alive!",
      logoutFailedRetry: "Couldn't log you out. Please try again.",
      unenrollFailed: "Failed to unenroll. Please try again.",
      noNewXpModule: "You already finished this module, so there's no new XP this time.",
      noNewXpQuiz: "No new XP. You didn't beat your best score this time.",
      unenrolledFrom: "You've left \"{title}\". You can re-join anytime.",
      deleteConfirmType: "Please type DELETE to confirm profile removal.",
      profileDeleted: "Your profile has been removed. We'll miss you, Explorer!",
      ...
      courseCompleted: "Mastery Unlocked! You completed the course and earned +100 XP! Amazing work! 🏆",
  ...
  es: {
    ...
    toasts: {
      ...
      btnRetry: "Reintentar",
      // Mensajes
      loginSuccess: "¡Has iniciado sesión! Sigue con tu racha.",
      loginGoogleSuccess: "¡Sesión iniciada con Google! A seguir aprendiendo.",
      signupSuccess: "¡Tu cuenta está lista! Explora cursos y gana XP.",
      signupGoogleSuccess: "¡Tu cuenta está lista! Explora cursos y gana XP.",
      quizScoreSaved: "Tu puntuación está en la clasificación. ¡Bien hecho!",
      ...
      logoutSafe: "Sesión cerrada de forma segura. ¡Vuelve mañana para mantener tu racha!",
      logoutFailed: "Error al cerrar sesión.",
      loggedOut: "Sesión cerrada de forma segura. ¡Vuelve mañana para mantener tu racha!",
      ...
      noNewXpModule: "Ya terminaste este módulo, así que no hay XP nuevo esta vez.",
      noNewXpQuiz: "Sin XP nuevo. Esta vez no superaste tu mejor puntuación.",
      unenrolledFrom: "Saliste de \"{title}\". Puedes volver cuando quieras.",
      deleteConfirmType: "Escribe DELETE para confirmar la eliminación del perfil.",
      profileDeleted: "Tu perfil fue eliminado. ¡Te extrañaremos, Explorador!",

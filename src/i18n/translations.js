  ...
  en: {
    ...
    doc: {
      ...
      features: [
        ...
        { title: "XP, Levels & Badges", text: "Earn XP for finishing modules (+50) and courses (+100) and level up from Rookie Coder to Grandmaster. Your profile fills with animated badges as you go — first quiz, first course, scholar, and special awards like Champion (reach #1 on the leaderboard) and Streak Master (a 30-day streak). Big moments play a celebration animation." },
  ...
  es: {
    ...
    doc: {
      ...
      features: [
        ...
        { title: "XP, Niveles e Insignias", text: "Gana XP al terminar módulos (+50) y cursos (+100) y sube de Novato Coder a Gran Maestro. Tu perfil se llena de insignias animadas: primer cuestionario, primer curso, erudito y premios especiales como Campeón (llega al puesto #1) y Maestro de Rachas (racha de 30 días). Los grandes momentos muestran una animación de celebración." },
